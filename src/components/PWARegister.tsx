...
export function PWARegister() {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 z-50 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 sm:bottom-8">
      <div className="flex w-full flex-col gap-3 rounded-2xl border border-acai-100/60 bg-white/95 p-4 shadow-2xl backdrop-blur-lg animate-fade-up dark:border-acai-800/60 dark:bg-acai-950/95">
