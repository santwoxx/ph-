    ...
    <div className="fixed bottom-6 left-1/2 z-50 flex w-[calc(100%-2rem)] max-w-md -translate-x-1/2 flex-col gap-3 rounded-2xl border border-acai-100/60 bg-white/95 p-4 shadow-2xl backdrop-blur-lg animate-fade-up dark:border-acai-800/60 dark:bg-acai-950/95 sm:bottom-8">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 pt-0.5">
          <h3 className="text-base font-bold text-acai-950 dark:text-white">Baixar App Açaí do PH</h3>
          <p className="text-sm text-acai-600 dark:text-acai-300 mt-1 leading-snug">
            {isIOS 
              ? "Instale nosso app para pedir mais rápido e ter a melhor experiência!" 
              : "Instale nosso app para pedir mais rápido direto da sua tela inicial!"}
          </p>
        </div>
        ...
        <button
          ...
          aria-label="Fechar"
          className="shrink-0 rounded-full p-1.5 text-acai-400 hover:bg-acai-50 hover:text-acai-600 dark:hover:bg-acai-900 transition-colors"
        >
          <X className="h-5 w-5" />
        </button>
      </div>
      ...
      {isIOS ? (
        <div className="mt-1 flex items-center justify-center gap-2 rounded-xl bg-acai-50/80 px-4 py-3 text-sm text-acai-800 dark:bg-acai-900/50 dark:text-acai-200 border border-acai-100 dark:border-acai-800">
          <span>Toque em</span>
          <Share className="h-5 w-5 text-acai-600 dark:text-acai-400" />
